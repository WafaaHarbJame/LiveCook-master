...
import com.livecook.livecookapp.Fragment.LoginFragment;
...
public class LoginPageActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, HomeFragment.OnFilterChangeListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.mainContainer, new LoginFragment(), "HomeFragment").addToBackStack(null).
                commit();
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (status) {
                        ...
                        Toast.makeText(LoginPageActivity.this, "تم الخروج بنجاح", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(LoginPageActivity.this, "لم يتم تسجيل الخررج" + message, Toast.LENGTH_SHORT).show();
